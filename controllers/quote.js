...
exports.createPDF = (req, res, next) => {
    ...
    // pdfDoc.pipe(fs.createWriteStream(path.join('assets', quoteName)));
    // fs.unlinkSync(`/home/nicolas/Documents/dev/Projects/Ozix/Ozixcommerce/app/api/assets/${quoteName}`);
    pdfDoc.pipe(res);
    pdfDoc.end();
};
